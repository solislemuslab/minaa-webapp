  ...
  sidebarLayout(
    sidebarPanel(
      div(
        ...
        # Run Button
        fluidRow(
          actionButton("vis_submitInputs", label = "Run", class = "btn-primary btn-lg", width = "100%")  # Unique ID
        )
      )
    ),
    ...
    mainPanel(
      ...
      # Plotly output
      withSpinner(plotlyOutput("vis_networkPlot", height = "1000px", width = "1000px")),
