AboutTab <- tabPanel("About",
                     ...
                     tags$ul(
                       tags$li("CSV adjacency matrix where the first column is the labels of G, and first row is the labels of H."), 
                     ...
                     h2("The Manuscript"),
                     p("For a more detailed description of the MiNAA algorithm, a",
                       a(href="https://arxiv.org/abs/2212.05880", "manuscript"),
                       "is currently available on arXiv."),
                     h3("Simulations in the Manuscript"),
                     p("All scripts and instructions to reproduce the analyses in the manuscript can be found in the",
                     ...
                     p("Users interested in expanding functionalities in MiNAA are welcome to do so. Issues reports are encouraged through the",
